...
namespace Backend.Migrations
{
    ...
    [Migration("20250322154444_AddWeightAndSizeToPetProfile")]
    partial class AddWeightAndSizeToPetProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.ChatSession", b =>
                {
                    ...
                    b.Property<string>("FinderEphemeralId")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("FinderSurname")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ScanMyPaws.Models.PetCardSetting", b =>
                {
                    b.Property<int>("PetCardSettingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PetCardSettingId"));
                    ...
                    b.Property<bool>("AlternativeContact")
                        .HasColumnType("bit");

                    b.Property<bool>("BreedName")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("MobilePhone1")
                        .HasColumnType("bit");

                    b.Property<bool>("MobilePhone2")
                        .HasColumnType("bit");

                    b.Property<int>("PetId")
                        .HasColumnType("int");

                    b.Property<bool>("PetName")
                        .HasColumnType("bit");
                    ...
                    b.HasKey("PetCardSettingId");

                    b.HasIndex("PetId");

                    b.ToTable("PetCardSettings");
                });

            modelBuilder.Entity("Backend.Models.ChatMessage", b =>
                {
                    b.HasOne("Backend.Models.ChatSession", null)
                        .WithMany("Messages")
